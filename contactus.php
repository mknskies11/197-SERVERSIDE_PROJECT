...
<body>
        ...
        <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
              ...
              <li class="nav-item">
                <a class="nav-link active mx-lg-2" href="contactus.html">Contact Us</a>
              </li>
              <li class="nav-item">
  ...
  <div class="wrapper">
    <form action="">
      <h1 style="font-family: Poppins;">Contact Us</h1>
      <div class="input-box">
      ...
      <div class="input-box">
        <input type="text" placeholder="Type your inquiry/message here">
      </div>
      <div class="register-link">
        <p>Or send your inquiry to <b>inquiries@monochromefashion.com</b></p>
      </div>
      
      <br>
      <button type="submit" class="btn">Send</button> <br><br>
      ...
      <div class="row">
        ...
        <div class="footer-col">
          ...
          <ul>
            ...
            <li><a href="#">Monochrome Archive</a></li>
